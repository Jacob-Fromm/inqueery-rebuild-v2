    ...
    <div className="container mx-auto px-6">
      <div className="md:flex md:items-center">
        ...
        <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
          <h3 className="text-white uppercase text-lg">{title}</h3>
          ...
          <div className="mt-2">
            ...
            <div className="flex items-center mt-1">
              <button onClick={() => handleCount(1)}className="text-white focus:outline-none focus:text-white">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  strokeLinecap="round"
              ...
              <span className="text-white text-lg mx-2">{count}</span>
              <button onClick={() => handleCount(-1)} className="text-white focus:outline-none focus:text-white">
                <svg
                  className="h-5 w-5"
                  fill="none"
          ...
          <div className="flex items-center mt-6">
            ...
            <button className="mx-2 text-white border rounded-md p-2 hover:bg-gray-200 focus:outline-none">
              <svg
                className="h-5 w-5"
                fill="none"
                strokeLinecap="round"
      ...
      <div className="mt-16 md:w-2/3">
        <h3 className="text-white text-2xl font-medium">Description</h3>
        {body && <PortableText blocks={body?.en} className="text-white" />}
      </div>
    </div>
  );
}
